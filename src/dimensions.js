...
export const DIMENSIONS = Object.freeze({
  ...
  grieve: {
    ...
    baseline: 0.03, pulseHalfLifeHours: 1.5, moodHalfLifeHours: 30, settleRatio: 0.30,
    growPerHour: 0, satisfyMul: 0.60, dawnFreeze: false,
  },
  anger: {
    label: '生气与不满', group: 'emotion_negative', initialValue: 0.04,
    baseline: 0.02, pulseHalfLifeHours: 0.65, moodHalfLifeHours: 10, settleRatio: 0.18,
    growPerHour: 0, satisfyMul: 0.40, dawnFreeze: false,
  },
  anxiety: {
    label: '焦虑、担忧与害怕', group: 'emotion_negative', initialValue: 0.04,
    baseline: 0.03, pulseHalfLifeHours: 2, moodHalfLifeHours: 24, settleRatio: 0.26,
    growPerHour: 0, satisfyMul: 0.55, dawnFreeze: false,
  },
  hurt: {
    label: '受伤与委屈', group: 'emotion_negative', initialValue: 0.03,
    baseline: 0.02, pulseHalfLifeHours: 2.5, moodHalfLifeHours: 48, settleRatio: 0.34,
    growPerHour: 0, satisfyMul: 0.55, dawnFreeze: false,
  },
  loneliness: {
    label: '孤独与被冷落感', group: 'emotion_negative', initialValue: 0.04,
    baseline: 0.03, pulseHalfLifeHours: 3, moodHalfLifeHours: 60, settleRatio: 0.32,
    growPerHour: 0, satisfyMul: 0.50, dawnFreeze: false,
  },
  jealousy: {
    label: '吃醋与嫉妒', group: 'emotion_negative', initialValue: 0.02,
    baseline: 0.01, pulseHalfLifeHours: 1.5, moodHalfLifeHours: 20, settleRatio: 0.24,
    growPerHour: 0, satisfyMul: 0.45, dawnFreeze: false,
  },
  shame: {
    label: '羞耻与尴尬', group: 'emotion_negative', initialValue: 0.02,
    baseline: 0.01, pulseHalfLifeHours: 0.8, moodHalfLifeHours: 18, settleRatio: 0.22,
    growPerHour: 0, satisfyMul: 0.50, dawnFreeze: false,
  },
  security: {
